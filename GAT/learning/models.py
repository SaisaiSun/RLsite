...
class Embedder(nn.Module):
    def __init__(self,
        ...
        :param num_bases: This is to use the basis sharing trick used in GAT in general
...
class BasePairPredictor(nn.Module):
    ...
    def __init__(self, encoder, decoder=DotPredictor()):
        """This is an exemple GAT for link prediction, that uses the previous Embedder network
